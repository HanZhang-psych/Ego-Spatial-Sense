...
people), 200 epochs Adam, on the sensed evidence from
...
def fit_model(sacc, tt, A, BH6, BH4, m6, train, test, epochs):
    m = SearchModel()
    ...
    return m, dict(params=m.named_values(),
...
def main():
    ...
    m, out = fit_model(sacc, tt, A, BH6, BH4, m6, train, test, args.epochs)
